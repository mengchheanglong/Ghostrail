...
export function generateIntentPack(input: IntentPackInput): IntentPack {
...
function inferConstraints(goal: string, repositoryContext: string): string[] {
...
function inferNonGoals(goal: string, repositoryContext: string): string[] {
  const text = `${goal} ${repositoryContext}`.toLowerCase();
...
function inferAcceptanceCriteria(goal: string, repositoryContext: string): string[] {
  const text = `${goal} ${repositoryContext}`.toLowerCase();
...
function inferTouchedAreas(goal: string, repositoryContext: string): string[] {
  const text = `${goal} ${repositoryContext}`.toLowerCase();
...
function inferRisks(goal: string, repositoryContext: string): string[] {
  const text = `${goal} ${repositoryContext}`.toLowerCase();
  const risks: string[] = [
...
function inferOpenQuestions(goal: string, repositoryContext: string): string[] {
  const text = `${goal} ${repositoryContext}`.toLowerCase();
...
function scoreConfidence(text: string): "low" | "medium" | "high" {
