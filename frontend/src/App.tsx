...
function App() {
  ...
  // Clear policy error and reset tab when switching packs
  ...
  const handleUpdatePack = async (updates: Partial<IntentPack>) => {
    ...
    setHistoryKey(k => k + 1);
    // If the pack was just archived and "show archived" is off, deselect it
              ...
              <div id="detailCard" className="card no-top-margin">
                <ActionButtons
                  ...
                  onUpdate={updated => {
                    ...
                    // Deselect if just archived and showArchived is off
